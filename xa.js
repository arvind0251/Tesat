...
if (!isOwner) return reply("Special Features for Certain Users!!")
 ...
 if (!isOwner) return reply('*Mau Decript? Chat Owner 6281262797207*');
...
hamz.sendMessage(from, { image: { url: "https://files.catbox.moe/kryeb5.jpg" }, caption: teks28 }, { quoted: qlive })
}
break
case 'paptt4': {
teks28 = `SANGEAN KONTOL`
hamz.sendMessage(from, { image: { url: "https://files.catbox.moe/2j56j0.jpg" }, caption: teks28 }, { quoted: qlive })
}
break
case 'paptt5': {
teks28 = `SANGEAN KONTL`
hamz.sendMessage(from, { image: { url: "https://files.catbox.moe/jqj317.jpg" }, caption: teks28 }, { quoted: qlive })
}
break
default:
if (budy.startsWith('>')) {
