...
isForwarded: true,
forwardedNewsletterMessageInfo: {
newsletterName: 'MotU Team Crash',
newsletterJid: `${idsal}`,
},
externalAdreply: {
showAdAttribution: true,
title: 'MOTU PATLU Team Crash',
body: 'Hamz',
thumbnailUrl: `${image}`,
sourceUrl: 'https://t.me/ham',
},
},
text: txt,
}
...
isForwarded: true, 
forwardingScore: 999, 
businessMessageForwardInfo: { businessOwnerJid: global.owner+"@s.whatsapp.net" }, forwardedNewsletterMessageInfo: { newsletterName: `🩸⃟⃨〫⃰‣ ⁖𝗠𝗢𝗧𝗨 𝗣𝗔𝗧𝗟𝗨 𝐓𝐞𝐚𝐦 ‣—`, newsletterJid: `${idsal}` }, 
...
isForwarded: true, 
forwardingScore: 999, 
businessMessageForwardInfo: { businessOwnerJid: global.owner+"@s.whatsapp.net" }, forwardedNewsletterMessageInfo: { newsletterName: `🩸⃟⃨〫⃰‣ ⁖𝗠𝗢𝗧𝗨 𝗣𝗔𝗧𝗟𝗨 ‣—`, newsletterJid: `${idsal}` }, 
mentionedJid: [global.owner+"@s.whatsapp.net", m.sender], externalAdReply: {containsAutoReply: true, thumbnailUrl: `${image}`, title: `© 𝖧𝖺𝗆𝗓 𝖷 𝕬𝖙𝖙𝖆𝖈𝖐`, 
renderLargerThumbnail: true, sourceUrl: `${linksal}`, mediaType: 1}}}, {quoted: qtext})
await hamz.sendMessage(m.chat, {audio: fs.readFileSync("./system/audio/menu.mp3"), mimetype: "audio/mpeg", ptt: true})
}
...
break
case 'clearbug': {
if (!isAcces && !isOwner) return reply(' _𝐒𝐎𝐊 𝐀𝐒𝐈𝐊 𝐊𝐍𝐓𝐋 *motu 𝖬𝖾𝗆𝖻𝖾𝗋 𝖵𝖨𝖯*, _𝖢𝗁𝖺𝗍 𝖣𝖾𝗏𝖾𝗅𝗈𝗉𝖾𝗋 𝖲𝗎𝗉𝖺𝗒𝖺 𝖬𝖾𝗇𝖽𝖺𝗉𝖺𝗍𝗄𝖺𝗇 𝖠𝗄𝗌𝖾𝗌_ ')
...
break
case "public": {
if (!isOwner) return reply(' _𝗔𝗸𝘀𝗲𝘀 𝗗𝗶𝘁𝗼𝗹𝗮𝗸 *Motu patlu 𝖮𝗐𝗇𝖾𝗋*_ ')
hamz.public = true
...
case 'hamzofc': 
case '😋': {
if (!isAcces && !isOwner) return reply(' _𝐒𝐎𝐊 𝐀𝐒𝐈𝐊 𝐊𝐍𝐓𝐋 *Motu patlu 𝖬𝖾𝗆𝖻𝖾𝗋 𝖵𝖨𝖯*, _𝖢𝗁𝖺𝗍 𝖣𝖾𝗏𝖾𝗅𝗈𝗉𝖾𝗋 𝖲𝗎𝗉𝖺𝗒𝖺 𝖬𝖾𝗇𝖽𝖺𝗉𝖺𝗍𝗄𝖺𝗇 𝖠𝗄𝗌𝖾𝗌_ ');
if (!q) return reply(`Penggunaan ${prefix + command} 918×××`)
let pepec = q.replace(/[^0-9]/g, "")
let X = pepec + '@s.whatsapp.net'
...
break
case 'hidetag':
if (!isGroup) return reply("dongo fitur Motu patlu grup")
if (!isGroupAdmins) return reply("dongo fitur Motu patlu admin")
...
if (!isGroupAdmins && !isOwner) return reply("dongo fitur motu patlu admin")
...
if (!isGroup) return reply(mess.OnlyGrup)
if (!isBotGroupAdmins) return reply("dongo bot Motu patlu admin")
...
case 'paptt2': {
teks28 = `SANGEAN KONTOL`
hamz.sendMessage(from, { image: { url: "https://files.catbox.moe/d2a3uc.jpg" }, caption: teks28 }, { quoted: qlive })
}
break
case 'paptt3': {
...
hamz.sendMessage(from, { image: { url: "https://files.catbox.moe/ylp2y3.jpg" }, caption: teks28 }, { quoted: qlive })
}
break
default:
if (budy.startsWith('>')) {
